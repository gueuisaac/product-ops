...
*All statements are verifiable against the codebase. File references provided.*

---

## Overview

AI Reports generates periodic insights from customer data using a two-stage AI pipeline (filtering + generation). Reports are delivered via Slack or email on configurable schedules.
...
|--------|--------|-----------|
| Issues | Active | `reports/accessor.go:2269` |
| Call Recordings | Active | `reports/accessor.go:2280` |
| Manual Entries | Active | `reports/accessor.go:2285` |
| Activity Logs | Not implemented | `reports/accessor.go:2290` |
| Internal Messages | Not implemented | `reports/accessor.go:2293` |
...
**Delivery Methods** (`reporttypes/reporttypes.go:36-44`)
...
| `reports/accessor.go` | Data fetching and report generation |
